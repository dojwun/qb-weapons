...
Config.DurabilityMultiplier = {
    ...
    ["screwdriverset"]              = 0.15,
    ["harness"]                     = 0.15,
    ["weed_white-widow"]            = 0.15,
    ["weed_skunk"]                  = 0.15,
    ["weed_purple-haze"]            = 0.15,
    ["weed_og-kush"]                = 0.15,
    ["weed_amnesia"]                = 0.15,
    ["weed_ak47"]                   = 0.15,
    ["weed_white-widow_seed"]       = 0.15,
    ["weed_skunk_seed"]             = 0.15,
    ["weed_purple-haze_seed"]       = 0.15,
    ["weed_og-kush_seed"]           = 0.15,
    ["weed_amnesia_seed"]           = 0.15,
    ["weed_ak47_seed"]              = 0.15,
    ["weed_nutrition"]              = 0.15,
    ["lawyerpass"]                  = 0.15,
    ["empty_evidence_bag"]          = 0.15,
    ["filled_evidence_bag"]         = 0.15,
    ["tunerchip"]                   = 0.15,
    ["nitrous"]                     = 0.15,
    ["tire"]                        = 0.15,
    ["cryptostick"]                 = 0.15,
    ["fitbit"]                      = 0.15,
    ["advancedrepairkit"]           = 0.15,
    ["repairkit"]                   = 0.15,
    ["visa"]                        = 0.15,
    ["mastercard"]                  = 0.15,
    ["weaponlicense"]               = 0.15,
